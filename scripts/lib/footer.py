"""Footer unico compartido por todos los generadores Python.

Fuente unica de verdad del footer del sitio (ver docs/AUDITORIA-2026-08-TECNICA-DISENO.md
S3.1). Usa rutas absolutas ("/noticias/", etc.) para funcionar igual a cualquier
profundidad de carpeta sin logica de prefijo. Debe mantenerse identico a
scripts/lib/footer.js (version Node) y al <footer class="site-footer"> de index.html.
"""
